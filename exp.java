...
System.out.println("HRA:"+hra); System.out.println("DA:"+da);
System.out.println("Staff welare amount:"+swf);
System.out.println("P F:"+pf);
System.out.println("Salary:"+salary);
}
...
{
System.out.println("Enter Employee Details:"); Employee e=new
Employee();
e.display();
Programmer obj1=new Programmer();
obj1.display();
AssistProf obj2=new
AssistProf(); obj2.display();
